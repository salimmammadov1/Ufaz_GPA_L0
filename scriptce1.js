...
const calculate = () => {
    ...
    let heattrmain = document.querySelector("#heattrmain").value;
    let heattrreport = document.querySelector("#heattrreport").value;
   ...
   let heattrave = 
   (parseFloat(heattrreport)*1 +
   parseFloat(heattrmain)*2);
   ...
   let totalgrades = (mathave+physicsave+aomave+tomave+pwave+ibwave+frave+enave+heattrave+databave)/30;
